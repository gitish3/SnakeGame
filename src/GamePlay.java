...
//			rightmouth.paintIcon(this, h, snakexlength[0], snakeylength[0]);
		...
		if(e.getKeyCode() == KeyEvent.VK_RIGHT && git==false)
		{
			moves++;
			right=true;
		...
		if(e.getKeyCode() == KeyEvent.VK_LEFT && git==false)
		{
			moves++;
			left=true;
		...
		if(e.getKeyCode() == KeyEvent.VK_UP && git==false)
		{
			moves++;
			up=true;
		...
		if(e.getKeyCode() == KeyEvent.VK_DOWN && git==false)
		{
			moves++;
			down=true;
